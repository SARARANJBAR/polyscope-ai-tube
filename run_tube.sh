...
script="tube_processor.py"

# run on some svs examples
...
input_file_path="/rsrch9/home/plm/idso_fa1_pathology/TIER1/aitil_clia/raw_test_images/pilot_image_A.svs"
python3 $script --input_file_path "$input_file_path"  --output_dir "$output_dir"
...
file_pattern="*.svs"
total=$(find "$image_dir" -type f -name "$file_pattern" | wc -l)
count=0
